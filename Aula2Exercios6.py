...
print('Vamos calcular o mair divisor comum dos PARES mdc')
print()
print(f'Vamos calcular os números "5" e "35" = {math.gcd(5,35)}')
print(f'Vamos calcular os números "9" e "12" = {math.gcd(9,12)}')
print(f'Vamos calcular os números "1024" e "512" = {math.gcd(1024,512)}')
print(f'Vamos calculcar os númeors "22" e "44" = {math.gcd(22,44)}')
print('Vamos calcular os númeors "36" e "90"', math.gcd(36,90)) # Aqui usei sem formatação de string 'f' só para exercios.
print()
