...
print(f'Vamos calcular o fatoramento desse numeros abaixos',end='\n' * 2)

print(f'O fatorial da variavel {a} é = {math.factorial(a)}')
print(f'O fatorial da variavel {b} é = {math.factorial(b)}')
print(f'O fatorial da variavel {c} é = {math.factorial(c)}')
print(f'O fatorial da variavel {d} é = {math.factorial(d)}')
print(f'O fatorial da variavel {e} é = {math.factorial(e)}')
print('\n')
